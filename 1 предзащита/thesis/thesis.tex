...
{\Large Волочай Виктория Олеговна}

\vspace{2cm}

\vbox{\LARGE\bfseries
Верхние и нижние оценки несмещенной вычислительной сложности оптимизационной задачи Needle
}

\vspace{4cm}

{\Large Научный руководитель: доцент кафедры КТ М.~B.~Буздалов}
